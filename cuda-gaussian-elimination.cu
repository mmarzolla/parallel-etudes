/****************************************************************************
 *
 * cuda-gaussian-elimination.cu - Solve systems of linear equations in upper triangular form
 *
...
using suitable CUDA constructs.

To compile:

        nvcc cuda-gaussian-elimination.cu -o cuda-gaussian-elimination -lm

To execute:

        ./cuda-gaussian-elimination [N]

Example:

        ./cuda-gaussian-elimination 20

## Files

- [cuda-gaussian-elimination.cu](cuda-gaussian-elimination.cu)
